<?php $__env->startSection('list_surat'); ?>
        ...
        <tbody>
            <?php $__currentLoopData = $data_surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($item->tanggal_berakhir); ?></td>
                    <td><?php echo e($item->tujuan_kota); ?></td>
                    <td><?php echo e($item->tujuan_luar_kota); ?></td>
                    <td>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Drivers\xampp\htdocs\penilaian-pegawai\resources\views/content/surat/list.blade.php ENDPATH**/ ?>